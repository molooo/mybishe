...
function showEditor($id, $value='', $width='700px', $height='300px', $style='visibility:hidden;',$upload_state="true", $media_open=false, $type='all'){
    ...
    echo '
<script src="'. __ROOT__ .'/Public/js/kindeditor/kindeditor-min.js" charset="utf-8"></script>
<script src="'.  __ROOT__ .'/Public/js/kindeditor/lang/zh_CN.js" charset="utf-8"></script>
<script>
  var KE;
  KindEditor.ready(function(K) {
        KE = K.create("textarea[name=\''.$id.'\']", {
                        items : '.$items.',
                        cssPath : "' .  __ROOT__ . '/Public/js/kindeditor/themes/default/default.css",

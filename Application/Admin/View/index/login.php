...
<head>
   ...
   <!--  <link rel="stylesheet" href="assets/css/style.css"> -->
    ...
    <link rel="stylesheet" href="__PUBLIC__/assets/css/signin.css">
...
<body> 
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="account-box"> 
                        <form role="form" action="__APP__?m=admin&c=index&a=login"  method="post">
    ...
    <script type="text/javascript" src="__PUBLIC__/assets/js/map/gmap3.js"></script>

...
<head>
    ...
    <link rel="stylesheet" href="__PUBLIC__/assets/css/loader-style.css">
    <link rel="stylesheet" href="__PUBLIC__/assets/css/bootstrap.css">
    <link rel="stylesheet" href="__PUBLIC__/css/Market/adminmain.css">

    <link rel="stylesheet" type="text/css" href="__PUBLIC__/assets/js/progress-bar/number-pb.css">
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="__PUBLIC__/assets/ico/minus.png">
</head>
...
<body> 
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="__PUBLIC__/img/Market/3.jpg">Hi, <?php echo $adminname?> <b class="caret"></b>
                        </a>
    ...
    <div id="skin-select">
        <div id="logo">
         <h1><img src="__PUBLIC__/img/logofooter.png" width="191px"></h1>
        </div>
                ...
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="__APP__?m=Admin&c=Market&a=getList" title="Blog List"><i class="entypo-doc-text"></i><span>信息管理</span></a>
                                </li>
                                <li>
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip " href="__APP__?m=Admin&c=index&a=login" title="login">
    ...
    <script src="__PUBLIC__/assets/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script src="__PUBLIC__/assets/js/progress-bar/number-pb.js"></script>
    <script src="__PUBLIC__/assets/js/progress-bar/progress-app.js"></script>



    <!-- MAIN EFFECT -->
    <script type="text/javascript" src="__PUBLIC__/assets/js/preloader.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/bootstrap.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/app.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/load.js"></script>
    ...
    <script type="text/javascript" src="__PUBLIC__/assets/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="__PUBLIC__/assets/js/countdown/jquery.countdown.js"></script>



    <script src="__PUBLIC__/assets/js/jhere-custom.js"></script>

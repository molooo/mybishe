...
<head>
    ...
    <link rel="stylesheet" href="/ag_bishe/Application/Public/assets/css/style.css">
    <link rel="stylesheet" href="/ag_bishe/Application/Public/assets/css/loader-style.css">
    <link rel="stylesheet" href="/ag_bishe/Application/Public/assets/css/bootstrap.css">
    <link rel="stylesheet" href="/ag_bishe/Application/Public/css/Market/adminmain.css">

    <link rel="stylesheet" type="text/css" href="/ag_bishe/Application/Public/assets/js/progress-bar/number-pb.css">
    ...
    <script>
	    var PUBLIC = "/ag_bishe/Application/Public";
		var APP = "/ag_bishe/Application/index.php";
	</script>
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="/ag_bishe/Application/Public/assets/ico/minus.png">
</head>
...
<body> 
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="/ag_bishe/Application/Public/img/Market/3.jpg">Hi, <?php echo $adminname?> <b class="caret"></b>
                        </a>
    ...
    <div id="skin-select">
        <div id="logo">
         <h1><img src="/ag_bishe/Application/Public/img/logofooter.png" width="191px"></h1>
        </div>
                ...
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="/ag_bishe/Application/index.php?m=Admin&c=Market&a=getList" title="Blog List"><i class="entypo-doc-text"></i><span>信息管理</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="blog-detail.html" title="Blog Detail"><i class="entypo-newspaper"></i><span>类别管理</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip " href="/ag_bishe/Application/index.php?m=Admin&c=index&a=login" title="login">
    ...
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/jquery.js"></script>
    <script src="/ag_bishe/Application/Public/assets/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script src="/ag_bishe/Application/Public/assets/js/progress-bar/number-pb.js"></script>
    <script src="/ag_bishe/Application/Public/assets/js/progress-bar/progress-app.js"></script>



    <!-- MAIN EFFECT -->
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/preloader.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/bootstrap.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/app.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/load.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/main.js"></script>
    ...
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="/ag_bishe/Application/Public/assets/js/countdown/jquery.countdown.js"></script>



    <script src="/ag_bishe/Application/Public/assets/js/jhere-custom.js"></script>

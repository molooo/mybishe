...
<div class="nctouch-chat-layout">
  ...
  <div class="margin-heigh1">
    ...
    <div style="margin-left: 1100px;font-size:15px;"><a href="/ag_bishe/Application/index.php/Home/House/edithouse?houseid=<?php echo $v['id'];?>">编辑房屋信息</a>      <a href="/ag_bishe/Application/index.php/Home/House/xiajiahouse?houseid=<?php echo $v['id']?>">下架</a></div>
    </div>
    </div>
    </div>
    <?php }?>

...
<link rel="shortcut icon" href="/ag_bishe/Public/img/favicon.ico">
...
<!-- CSS
================================================== -->
<link rel="stylesheet" href="/ag_bishe/Public/prettyphoto/css/prettyPhoto.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/ag_bishe/Public/css/Index/flexslider.css" type="text/css" media="screen" /> <!-- Slider Stylesheet -->
<link rel="stylesheet" href="/ag_bishe/Public/css/Index/reset.css">
<link rel="stylesheet" href="/ag_bishe/Public/css/Index/style.css">
...
<div style="float:right;padding:10px;margin:10px;"> <!-- Logo Div -->
		<ul>
			<li><a href="/ag_bishe/home/index/login">登录</a></li>
			<li><a href="/ag_bishe/home/index/reg">注册</a></li>
		</ul>
	</div> <!-- Closes Logo Div -->
<div id="topband">

	<div id="logo"> <!-- Logo Div -->
			<img src="/ag_bishe/Public/img/Index/logofooter.png" alt="logo">
	</div> <!-- Closes Logo Div -->
...
<div id="menuband">
	...
	<ul id="menu1">
			...
			<li><a href="/ag_bishe/Home/House/" class="smoothScroll">房屋</a></li> <!-- menu item -->
			...
			<li><a href="/ag_bishe/Home/Pet" class="smoothScroll">宠物之家</a></li> <!-- menu item -->
...
<!-- Social Icons -->
		<div class="topsocialicons">
					...
					<div class="circlelarge" id="facebookiconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/facebook-icn.png" alt="facebook"></a>
					</div>

					<div class="circlelarge" id="hoteliconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/hotel-icn.png" alt="linkedin"></a>
					</div>

					<div class="circlelarge" id="twittericonlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/twitter-icn.png" alt="twitter"></a>
					</div>

					<div class="circlelarge" id="behanceiconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/behance-icn.png" alt="googleplus"></a>
					</div>

					<div class="circlelarge" id="dribbbleiconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/dribbble-icn.png" alt="dribbble"></a>
					</div>

					<div class="circlelarge" id="fleaiconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/flea-icn.png" alt="linkedin"></a>
					</div>

					<div class="circlelarge" id="linkediniconlarge">
						<a href="#"><img class="contactsocialicon2" src="/ag_bishe/Public/img/Index/linkedin-icn.png" alt="linkedin"></a>
					</div>
...
<br>
	        <div class="flexslider"> <!-- Slider gallery starts here -->
	          		<ul class="slides">
	            	<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider1.jpg" alt="galleryitem"  /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider2.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider3.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider4.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider5.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider6.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Public/img/Index/Slider7.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	          		</ul>
...
<br>
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-1.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-2.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-3.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-4.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-5.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-6.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-7.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-8.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Public/img/Index/Portfolio-Item-9.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div id="clients">   <!-- Clients Starts Here -->
	        		...
	        		<img id="logos" alt="logo" src="/ag_bishe/Public/img/Index/client-logos.png"> <!-- Clients Image Here -->
	...
	<div id="services"> <!-- Services open -->
		<div class="container" id="servicescontent" > <!-- Services content -->
			...
			<div id="whatwedo"> <!-- What We Do Starts Here -->
	     		...
	     		<div id="whatwedoicons"> <!-- open whatwedoicons -->
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/web-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/print-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			           ...
			           <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/design-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitemlast"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/seo-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
	       ...
	       <div id="processicons"> <!-- Start of process icons -->
	       		    ...
	       		    <div class="servicesitem"> <!-- Portfolio Item -->
			        	   <img class="servicesicon" src="/ag_bishe/Public/img/Index/research-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	   <div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/develop-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/test-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitemlast"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/launch-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
				...
				<div id="aboutusright"> <!-- about us right section div open -->
					...
					<div id="checklist"> <!-- about us checklist div starts here -->
						<div class="checklistitem"> <!-- checklist item div -->
							<img class="checkmark" alt="checkmark" src="/ag_bishe/Public/img/Index/check-mark-green.png"><p class="checkmarktext">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin auctor feugiat urna, id sagittis tellus pellentesque non.</p> <!-- Insert Your checklist text inside p tags -->
...
<!-- Team Starts Here -->
	...
	<div id="team">   <!-- team div open -->
		...
		<div id="teamcontent" class="container">  <!-- teamcontent div open -->
			...
			<img id="arrows" src="/ag_bishe/Public/img/Index/arrows-light.png" alt="arrows"> <!-- arrows image above workers -->
			...
			<div class="portrait"> <!-- portrait div open -->
				...
				<img src="/ag_bishe/Public/img/Index/photodune-2785700-happy-businessman-with-laptop-smiling-m.png" alt="Portrait"> <!-- worker image -->
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet consectetur.</p>
					...
					<img class="workersocialicon" src="/ag_bishe/Public/img/Index/mini-facebook-icon.png" alt="facebook">
					<img class="workersocialicon" src="/ag_bishe/Public/img/Index/mini-twitter-icon.png" alt="twitter">
					<img class="workersocialicon" src="/ag_bishe/Public/img/Index/mini-behance-icon.png" alt="behance">
					<img class="workersocialicon" src="/ag_bishe/Public/img/Index/mini-dribbble-icon.png" alt="dribbble">
					<img class="workersocialicon" src="/ag_bishe/Public/img/Index/mini-linkedin-icon.png" alt="linkedin">
				</div>
			...
			<div id="statsicons"> <!-- Start of Stats icons -->
	       		 ...
	       		 <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/coffee-icon.png" alt="webicon"> <!-- Stats Item Image -->
			        ...
			        <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/code-icon.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
			        ...
			        <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/work-con.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
			        ...
			        <div class="servicesitemlast"> <!-- Stats Item -->
			        	<img class="servicesicon" src="/ag_bishe/Public/img/Index/heart-icon.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
...
<div class="patternwhite"></div>
	<div id="footer"> <!-- footer div open -->
		...
		<div id="footercontent" class="container"> <!-- footer content wrapper div -->
			<img src="/ag_bishe/Public/img/Index/logofooter.png" alt="footerlogo"> <!-- footer logo image here -->
			<br> <!-- line break -->
			<br> <!-- line break -->
...
<!-- JS
================================================== -->
<script type="text/javascript" src="/ag_bishe/Public/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/ag_bishe/Public/js/script.js"></script>
<script type="text/javascript" src="/ag_bishe/Public/js/jquery.ez-bg-resize.js"></script>
<script type="text/javascript" src="/ag_bishe/Public/prettyphoto/js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="/ag_bishe/Public/js/smoothscrolling.js"></script>
<script src="/ag_bishe/Public/js/jquery.sticky.js" type="text/javascript"></script>
<script src="/ag_bishe/Public/js/css_browser_selector.js" type="text/javascript"></script> 
<script src="/ag_bishe/Public/js/formsubmit.js"></script>
...
<script type="text/javascript" charset="utf-8">
	...
	<!-- FlexSlider 
==================================================== -->
  <script defer src="/ag_bishe/Public/js/jquery.flexslider.js"></script>

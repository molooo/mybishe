...
<link rel="stylesheet" href="/ag_bishe/Application/Public/css/Index/style1.css">
<link href='http://fonts.useso.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
<link href='http://fonts.useso.com/css?family=Source+Sans+Pro' rel='stylesheet' type='text/css'>
<link href='http://fonts.useso.com/css?family=Open+Sans:700' rel='stylesheet' type='text/css'>
<link href='/ag_bishe/Application/Public/css/House/houselist1.css' rel='stylesheet' type='text/css' />
</head>
<body>
	<!-- Logo Starts Here 
==================================================== -->
...
<div style="float:right;padding:10px;margin:10px;"> <!-- Logo Div -->
	...
	<ul>
		<li><a href="/ag_bishe/Application/index.php/home/index/loginout">退出</a></li>
		</ul>
	   <?php }else{?>
		<ul>
...
<div class="search-bar" id="menuband1">
    <div class="search-barinner clearfix">
        <div class="t-search fl">
            ...
            <FORM action="/ag_bishe/Application/index.php/Home/House/search?leixing=<?php echo $leixing?>" method="POST">
                ...
                <div class="result-lists">
                    <div class="select-bar clearfix">
                        <ul class="sort-rule fl">
                            <li <?php if ($moren=='moren'){?>class='first curr'<?php }?>><a href='/ag_bishe/Application/index.php/Home/House/house_list?leixing=<?php echo $leixing?>'><span>默认</span></a></li>
                            <li <?php if ($moren=='zuixin'){?>class='first curr'<?php }?>><a href='/ag_bishe/Application/index.php/Home/House/zuixin?leixing=<?php echo $leixing?>'><span>最新</span></a></li>
                            <li <?php if ($moren=='zongjia'){?>class='first curr'<?php }?>><a href='/ag_bishe/Application/index.php/Home/House/zongjia?leixing=<?php echo $leixing?>'><span>总价</span><i class='sort_normal'></i></a></li>
                            <li <?php if ($moren=='chicun'){?>class='first curr'<?php }?>><a href='/ag_bishe/Application/index.php/Home/House/chicun?leixing=<?php echo $leixing?>'><span>面积</span><i class='sort_normal'></i></a></li>
                        </ul>
                        <p class="pagerTxt fr ">
 ...
 <?php foreach ($house_list as $key=>$value){?>
            <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item clearfix">
                <p class="item-photo fl">
                    <a href='/ag_bishe/Application/index.php/Home/House/detail?houseid=<?php echo $value['id']?>' target='_blank'>
                        <img class="lazy" data-original='/ag_bishe/Application/index.php/Home/House/'
                            src="/ag_bishe/Application/Public/img/House/public1.jpg" alt='<?php echo $value['housename']?>200万'
                            title='<?php echo $value['housename']?>200万' /></a>
                </p>
                <div class="item-info fl">
                    <h4 class="house-title">
                        <a href="/ag_bishe/Application/index.php/Home/House/detail?houseid=<?php echo $value['id']?>" class="cBlueB" title="<?php echo $value['housename']?>" target="_blank"><?php echo $value['housename']?></a>
                    </h4>
                    ...
                    <?php if ($value['leixing']!=3){?>
                        <span class='tag_red'>独家</span><span class='tag_orange'>随时看房</span><span class='tag_orange'><a href="/ag_bishe/Application/index.php/Home/House/kefu?housename=<?php echo $value['housename']?>&houseprice=<?php echo $value['houseprice']?>&lianxirenid=<?php echo $value['lianxirenid']?>">与卖家联系</a></span>
                    <?php }else{?>
                ...
                <div class="item-pricearea fr">
                    ...
                    <p class="f14 f000 mb_15 fsm"><?php echo $value['houseprice']; if ($leixing==2){?>元/平米<?php }elseif ($leixing==1){?>元/月<?php }?></p>
                </div>

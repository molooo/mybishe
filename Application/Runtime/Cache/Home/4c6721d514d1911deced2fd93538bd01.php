...
<header id="header">
  <div class="header-wrap">
    ...
    <div class="header-title">
      <h1><a href="/ag_bishe/Application/index.php/Home/House/hyzx">消息列表</a>   <a href="/ag_bishe/Application/index.php/Home/House/guanli">管理房屋</a>  </h1>
    </div>
...
<div class="nctouch-chat-layout">
  ...
  <?php foreach ($liaotian_list as $v){?>
    <div class="margin-heigh1">
    
    <div class="nctouch-chat-product"> 
    <div class="goods-info"><div class="goods-name"><?php echo $v?><SPAN style="margin-left:1000px; font-size:15px;"><a href="/ag_bishe/Application/index.php/Home/House/jilu?receivename=<?php echo $v?>">聊天记录</a> <a href="/ag_bishe/Application/index.php/Home/House/huifu?receivename=<?php echo $v?>">回复</a></SPAN></div>
    </div>

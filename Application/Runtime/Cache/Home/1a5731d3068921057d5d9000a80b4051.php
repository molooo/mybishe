...
<div id="menuband">
	...
	<ul id="menu1">
			<li><a href="/ag_bishe/Application/index.php/Home/" class="smoothScroll">首页</a></li> <!-- menu item -->
			...
			<li><a href="/ag_bishe/Application/index.php/Home/Train/" class="smoothScroll">教育</a></li> <!-- menu item -->

			<li><a href="/ag_bishe/Application/index.php/Home/Car" class="smoothScroll">二手车</a></li> <!-- menu item -->
			...
			<li><a href="/ag_bishe/Application/index.php/Reviews" class="smoothScroll">消费点评</a></li> <!-- menu item -->
...
<!-- Social Icons -->
		<div class="topsocialicons">
					...
					<div class="circlelarge" id="linkediniconlarge">
						<a href="/ag_bishe/Application/index.php/Reviews"><img class="contactsocialicon2" src="/ag_bishe/Application/Public/img/Index/linkedin-icn.png" alt="linkedin"></a>
					</div>
...
<br>
	        <div class="flexslider"> <!-- Slider gallery starts here -->
	            	...
	            	<li>
	  	    		...
	  	    		<li><a href="/ag_bishe/Application/index.php/Reviews">
...
<br>
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="/ag_bishe/Application/Public/img/Index/example.png"><img class="portfolioitem" src="/ag_bishe/Application/Public/img/Index/Portfolio-Item-7.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<a href="/ag_bishe/Application/index.php/Reviews"><div class="portfolioitemtitleholder">
...
================================================== -->
	<script>
		var Url = "/ag_bishe/Application/Public";
	</script>

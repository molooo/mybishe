...
<link rel="stylesheet" href="/ag_bishe/Application/Public/css/car/css/common.css">
<link rel="stylesheet" href="/ag_bishe/Application/Public/css/car/css/inside.css">
...
.introh1 {
	...
	margin-top:-10px;
	line-height: 1.1em;
	text-shadow: 5px 1px 0px rgba(0,0,0,0.25);
}
.introh4 {
	font-family:黑体;
	font-size: 50px;
...
<div id="menuband">
	...
	<ul id="menu1">			
			...
			<li><a href="/ag_bishe/Application/index.php/Home/" class="smoothScroll">返回</a></li> <!-- menu item -->
	</ul>
...
<br>
	        <div class="flexslider"> <!-- Slider gallery starts here -->
	          		<ul class="slides">
	            	<li>
	  	    	    <img src="/ag_bishe/Application/Public/img/car/1.jpg" alt="galleryitem"  /></li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Application/Public/img/car/2.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Application/Public/img/car/3.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Application/Public/img/car/4.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="/ag_bishe/Application/Public/img/car/7.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
...
<div id="hall_show" class="wrap">
  ...
  <ul class="hallImg_show clearfix">
    <li><img alt="大搜车，二手车，展馆，洽谈室" src="/ag_bishe/Application/Public/img/car/images/hall1.jpg" /></li>
    <li><img alt="大搜车，二手车，展馆，接待区" src="/ag_bishe/Application/Public/img/car/images/hall2.jpg" /></li>
    <li><img alt="大搜车，二手车，展馆，儿童区" src="/ag_bishe/Application/Public/img/car/images/hall3.jpg" /></li>
    <li><img alt="大搜车，二手车，展馆，旗舰式展厅" src="/ag_bishe/Application/Public/img/car/images/hall4.jpg" /><ins>国际会展设施  可同时容纳超过700辆车</ins></li>
    <li><img style="width:380px;height:290px;" alt="大搜车，二手车，夜店，晚上22:00点" src="/ag_bishe/Application/Public/img/car/222.jpg" /><ins>贴心服务，只为客户<br/>
      </ins></li>
  </ul>
</div>
<!--hall_show end--> 
...
<div id="checkCar" class="wrap">
  ...
  <div class="checkCar_show clearfix"> <img src="/ag_bishe/Application/Public/img/car/images/check1.jpg" /> <img src="/ag_bishe/Application/Public/img/car/images/check2.jpg" /> <img src="/ag_bishe/Application/Public/img/car/images/check3.jpg" /> </div>
  <p class="check_decorate"><ins>360度全方位检测</ins>提供详细专业的检测报告</p>
  <img src="/ag_bishe/Application/Public/img/car/images/check4.jpg"  class="check_img" /> </div>
<!--rideCar end--> 

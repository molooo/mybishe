                ...
                <div class="result-lists">
                    <div class="select-bar clearfix">
                        <ul class="sort-rule fl">
                            <li style="margin-left:550px;font-size:21px;"><span><a href="__APP__/Home/House/fabu">编辑房屋信息</a></span></li>
                       </ul>
                </div>
...
<div class="middle-layout" >
  ...
  <form method="POST" id="house_form" action="__APP__/home/house/edit" enctype=”multipart/form-data">
    <?php if ($house_message[0]['leixing'] == 3){?>
    <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                新楼盘名称：                  <INPUT type="text" name = "housename" id="housename" value="<?php echo $house_message[0]['housename']?>">
      </p>
      </div>
     </div>
    <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
              新楼盘价格（每套）：<INPUT type="text" name = "amountprice" id="amountprice" value="<?php echo $house_message[0]['amountprice']?>">万
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                新楼房地址：<INPUT type="text" name = "houseaddress" id="houseaddress" value="<?php echo $house_message[0]['houseaddress']?>">
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                新房属性：<INPUT type="text" name = "shi" id="shi" value="<?php echo $house_message[0]['shi']?>">室<INPUT type="text" name = "ting" id="ting" value="<?php echo $house_message[0]['ting']?>">厅<INPUT type="text" name = "wei" id="wei" value="<?php echo $house_message[0]['wei']?>">卫
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                新房尺寸：<INPUT type="text" name = "chicun" id="chicun" value="<?php echo $house_message[0]['chicun']?>">平米
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
...
上传房屋图片： <ul class="goods-pic-list" nctype="">
    ...
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                新楼盘联系人：<INPUT type="text" name = "lianxirenname" id="lianxirenname" value="<?php echo $house_message[0]['lianxirenname']?>">
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                售楼处联系电话：<INPUT type="text" name = "phone" id="phone" value="<?php echo $house_message[0]['phone']?>">
      </p>
      </div>
     </div>
      <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
...
<span class='tag_orange'><INPUT type="submit" value="发布房屋"></span>      </p>
    ...
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                房屋名称：                  <INPUT type="text" name = "housename" id="housename" value="<?php echo $house_message[0]['housename']?>">
      </p>
      </div>
     </div>
    <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
              房屋价格/每平米(二手房)/每月(租房)：<INPUT type="text" name = "houseprice" id="houseprice" value="<?php echo $house_message[0]['houseprice']?>">
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
              房屋总价格（二手房）：<INPUT type="text" name = "amountprice" id="amountprice" value="<?php echo $house_message[0]['amountprice']?>">万
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                房屋地址：<INPUT type="text" name = "houseaddress" id="houseaddress" value="<?php echo $house_message[0]['houseaddress']?>">
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                房屋属性：<INPUT type="text" name = "shi" id="shi" value="<?php echo $house_message[0]['shi']?>">室<INPUT type="text" name = "ting" id="ting" value="<?php echo $house_message[0]['ting']?>">厅<INPUT type="text" name = "wei" id="wei" value="<?php echo $house_message[0]['wei']?>">卫
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                房屋尺寸：<INPUT type="text" name = "chicun" id="chicun" value="<?php echo $house_message[0]['chicun']?>">平米
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
...
上传房屋图片： <ul class="goods-pic-list" nctype="">
    ...
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                联系人名称：<INPUT type="text" name = "lianxirenname" id="lianxirenname" value="<?php echo $house_message[0]['lianxirenname']?>">
      </p>
      </div>
     </div>
     <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">
    <div class="item-info fl">                    
                <p class="f14 f000 mb_10">
                联系人电话：<INPUT type="text" name = "phone" id="phone" value="<?php echo $house_message[0]['phone']?>">
      </p>
      </div>
     </div>
      <div id="37ca7c51-d300-c49d-c237-08d2fa19a5d1" class="house-item1 clearfix">

...
<div class="nctouch-chat-layout">
  ...
  <div class="nctouch-chat-bottom">
    <div class="chat-input-layout">        <span class="ke-outline" data-name="emoticons" title="插入表情" unselectable="on"><span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-emoticons" unselectable="on"></span></span>
      <div class="input-box">
  		<form method="POST" id="house_form" action="__APP__/home/house/kefu?lianxirenid=<?php echo $lianxirenid;?>&housename=<?php echo $housename?>&houseprice=<?php echo $houseprice?>">
...
<script src="__PUBLIC__/js/kindeditor/kindeditor-min.js" charset="utf-8"></script>
<script src="__PUBLIC__/js/kindeditor/lang/zh_CN.js" charset="utf-8"></script>
<script>
  var KE;

...
<!-- Sticky Nav Bar -->
	<div id="hiddenmenu"> <!-- Hidden Menu bar div open -->
		<ul id="menu">
			...
			<li><a href="__APP__/Home/House/newhouse.html" class="smoothScroll">新房</a></li> <!-- menu item -->
			
			<li><a href="__APP__/Home/House/" class="smoothScroll">二手房</a></li> <!-- menu item -->
			
			<li><a href="#about" class="smoothScroll">租房</a></li> <!-- menu item -->

			<li><a href="#team" class="smoothScroll">论坛</a></li> <!-- menu item -->

			<li><a href="__APP__/Home/House/public.html" class="smoothScroll">发布</a></li> <!-- menu item -->
...
<br>
	        <div class="flexslider"> <!-- Slider gallery starts here -->
	          		<ul class="slides">
	            	<li>
	  	    	    <img src="__PUBLIC__/img/House/house1.jpg" alt="galleryitem"  /></li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house2.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house3.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house4.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house5.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house6.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/House/house7.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	          		</ul>
...
<br>
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/House/example.png"><img class="portfolioitem" src="__PUBLIC__/img/House/h2.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/House/h3.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
		        		<h6 class="portfoliotitle">Project Title Goes Here</h6> <!-- Portfolio Item Title -->
		        	</div>
	        			<p class="galleryitemdescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam quis nisi quis odio</p> <!-- Portfolio Item Description-->
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/House/h4.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
		        		<h6 class="portfoliotitle">Project Title Goes Here</h6> <!-- Portfolio Item Title -->
		        	</div>
	        			<p class="galleryitemdescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam quis nisi quis odio</p> <!-- Portfolio Item Description-->
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/House/h5.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
		        		<h6 class="portfoliotitle">Project Title Goes Here</h6> <!-- Portfolio Item Title -->
		        	</div>
	        			<p class="galleryitemdescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam quis nisi quis odio</p> <!-- Portfolio Item Description-->
...
<script type="text/javascript" src="__PUBLIC__/js/scripthouse.js"></script>

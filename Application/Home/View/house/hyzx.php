...
<div class="nctouch-chat-layout">
  ...
  <?php foreach ($liaotian_list as $v){?>
    ...
    <div class="goods-info"><div class="goods-name"><?php echo $v?><SPAN style="margin-left:1000px; font-size:15px;"><a href="__APP__/Home/House/jilu?receivename=<?php echo $v?>">聊天记录</a> <a href="__APP__/Home/House/huifu?receivename=<?php echo $v?>">回复</a></SPAN></div>
    </div>

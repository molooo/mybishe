    ...
    <div class="container_12">
        <div class="grid_12">
            ...
            <div class="menu_block">
                <nav  class="" >
                    <ul class="sf-menu">
                        <li class="current"><a href="__APP__/Home/Pet/index">首页</a></li>
                        <li class="with_ul"><a href="__APP__/Home/Pet/ency">宠物百科 </a></li>
...
<div class="top_block">
    <div class="slider-relative">
        <div class="slider-block">
            <div class="slider">
                <ul class="items">
                    <li><img src="__PUBLIC__/img/Pet/slide.jpg" alt="">
                        <div class="banner">They Need  Your <span>Love</span> and <i>Care</i><p>It is so easy to make them happy</p></div>
                    </li>
                    <li><img src="__PUBLIC__/img/Pet/slide1.jpg" alt="">
                        <div class="banner">They Need  Your <span>Love</span> and <i>Care</i><p>It is so easy to make them happy</p></div>
                    </li>
                    <li><img src="__PUBLIC__/img/Pet/slide2.jpg" alt="">
                        <div class="banner">They Need  Your <span>Love</span> and <i>Care</i><p>It is so easy to make them happy</p></div>
                    </li>
                    <li><img src="__PUBLIC__/img/Pet/slide3.jpg" alt="">
                        <div class="banner">They Need  Your <span>Love</span> and <i>Care</i><p>It is so easy to make them happy</p></div>
                    </li>
                </ul>
            </div>
...
<div class="page1_block">
    <div class="container_12">
        <div class="grid_6">
            <h2>欢迎来到宠物之家</h2><br>
            <img src="__PUBLIC__/img/Pet/page1_img5.jpg" alt="" class="img_inner fleft">
...
<div class="content page1"><div class="ic">More Website Templates @ <a href="http://www.cssmoban.com/" >网页模板</a> - June 10, 2013!</div>
    <div class="container_12">
        ...
        <ul class="carousel1">
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img1.jpg" alt="" class="img_inner fleft">
            ...
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img2.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
            ...
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img3.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
            ...
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img4.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit.
                </div>
            </li>
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img5.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit.
                </div>
            </li>
            <li class="grid_4">
                <img src="__PUBLIC__/img/Pet/carousel1_img6.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper pad1">
                    <p class="col2"><a href="#">Aeraesent quis hoj rcieget diam iverral.</a></p>Loaesent quis orci diam viverralopr con equat. Lusce sagittis quam ihui hyhy opir pulvinarhjk velit.
                </div>
            </li>
...
<div class="bottom_block">
    <div class="container_12">
        ...
        <div class="grid_4 prefix_2">
            ...
            <img src="__PUBLIC__/img/Pet/page1_img4.jpg"

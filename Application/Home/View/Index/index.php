...
================================================== -->
<meta charset="utf-8">
<title>Welcome to the service for life</title>
...
<div id="menuband">
	...
	<ul id="menu1">
			<li><a href="__APP__/Home/" class="smoothScroll">首页</a></li> <!-- menu item -->
			
			<li><a href="__APP__/Home/House/" class="smoothScroll">房屋</a></li> <!-- menu item -->
			
			<li><a href="#services" class="smoothScroll">酒店</a></li> <!-- menu item -->
			
			<li><a href="__APP__/Home/Train/" class="smoothScroll">教育</a></li> <!-- menu item -->

			<li><a href="__APP__/Home/Car" class="smoothScroll">二手车</a></li> <!-- menu item -->

			<li><a href="__APP__/Home/Pet" class="smoothScroll">宠物之家</a></li> <!-- menu item -->

			<li><a href="#team" class="smoothScroll">跳蚤市场</a></li> <!-- menu item -->

			<li><a href="__APP__/Reviews" class="smoothScroll">消费点评</a></li> <!-- menu item -->
...
<br>
	        <div class="flexslider"> <!-- Slider gallery starts here -->
	          		<ul class="slides">
	            	<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider1.jpg" alt="galleryitem"  /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider2.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider3.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider4.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider5.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li>
	  	    	    <img src="__PUBLIC__/img/Index/Slider6.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</li>
	  	    		<li><a href="__APP__/Reviews">
	  	    	    <img src="__PUBLIC__/img/Index/Slider7.jpg" alt="galleryitem" /> <!-- Slider gallery image here -->
	  	    		</a></li>
	          		</ul>
...
<br>
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-1.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-2.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-3.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-4.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-5.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-6.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
			...
			<div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-7.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<a href="__APP__/Reviews"><div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-8.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div class="galleryitem"> <!-- Portfolio Item -->
	        	<a rel="prettyPhoto" title="Project Title Here" href="__PUBLIC__/img/Index/example.png"><img class="portfolioitem" src="__PUBLIC__/img/Index/Portfolio-Item-9.jpg" alt="Portfolio Item"></a> <!-- Portfolio Item Image -->
		        	<div class="portfolioitemtitleholder">
	        ...
	        <div id="clients">   <!-- Clients Starts Here -->
	        		...
	        		<img id="logos" alt="logo" src="__PUBLIC__/img/Index/client-logos.png"> <!-- Clients Image Here -->
	...
	<div id="services"> <!-- Services open -->
		<div class="container" id="servicescontent" > <!-- Services content -->
			...
			<div id="whatwedo"> <!-- What We Do Starts Here -->
	     		...
	     		<div id="whatwedoicons"> <!-- open whatwedoicons -->
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/web-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/print-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			           ...
			           <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/design-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitemlast"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/seo-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
	       ...
	       <div id="processicons"> <!-- Start of process icons -->
	       		    ...
	       		    <div class="servicesitem"> <!-- Portfolio Item -->
			        	   <img class="servicesicon" src="__PUBLIC__/img/Index/research-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	   <div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/develop-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitem"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/test-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
			        ...
			        <div class="servicesitemlast"> <!-- Portfolio Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/launch-icon.png" alt="webicon"> <!-- Portfolio Item Image -->
				        	<div class="portfolioitemtitleholder">
				...
				<div id="aboutusright"> <!-- about us right section div open -->
					...
					<div id="checklist"> <!-- about us checklist div starts here -->
						<div class="checklistitem"> <!-- checklist item div -->
							<img class="checkmark" alt="checkmark" src="__PUBLIC__/img/Index/check-mark-green.png"><p class="checkmarktext">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin auctor feugiat urna, id sagittis tellus pellentesque non.</p> <!-- Insert Your checklist text inside p tags -->
...
<!-- Team Starts Here -->
	...
	<div id="team">   <!-- team div open -->
		...
		<div id="teamcontent" class="container">  <!-- teamcontent div open -->
			...
			<img id="arrows" src="__PUBLIC__/img/Index/arrows-light.png" alt="arrows"> <!-- arrows image above workers -->
			...
			<div class="portrait"> <!-- portrait div open -->
				...
				<img src="__PUBLIC__/img/Index/photodune-2785700-happy-businessman-with-laptop-smiling-m.png" alt="Portrait"> <!-- worker image -->
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet consectetur.</p>
					...
					<img class="workersocialicon" src="__PUBLIC__/img/Index/mini-facebook-icon.png" alt="facebook">
					<img class="workersocialicon" src="__PUBLIC__/img/Index/mini-twitter-icon.png" alt="twitter">
					<img class="workersocialicon" src="__PUBLIC__/img/Index/mini-behance-icon.png" alt="behance">
					<img class="workersocialicon" src="__PUBLIC__/img/Index/mini-dribbble-icon.png" alt="dribbble">
					<img class="workersocialicon" src="__PUBLIC__/img/Index/mini-linkedin-icon.png" alt="linkedin">
				</div>
			...
			<div class="portraitlast"> <!-- portrait div open -->
				...
				<img src="__PUBLIC__/img/Index/photodune-2785700-happy-businessman-with-laptop-smiling-m.png" alt="Portrait"> <!-- worker image -->
				<span class="name">Dave</span> <!-- worfker name -->
				<br> 
			...
			<div id="statsicons"> <!-- Start of Stats icons -->
	       		 ...
	       		 <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/coffee-icon.png" alt="webicon"> <!-- Stats Item Image -->
			        ...
			        <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/code-icon.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
			        ...
			        <div class="servicesitem"> <!-- Stats Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/work-con.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
			        ...
			        <div class="servicesitemlast"> <!-- Stats Item -->
			        	<img class="servicesicon" src="__PUBLIC__/img/Index/heart-icon.png" alt="webicon"> <!-- Stats Item Image -->
				        	<div class="portfolioitemtitleholder"> <!-- stats title holder div -->
...
<div class="patternwhite"></div>
	<div id="footer"> <!-- footer div open -->
		...
		<div id="footercontent" class="container"> <!-- footer content wrapper div -->
			<img src="__PUBLIC__/img/Index/logofooter.png" alt="footerlogo"> <!-- footer logo image here -->
			<br> <!-- line break -->
			<br> <!-- line break -->
			<p id="copyright"> &#169; Graduation Design 2016. Copyright by tj-edu <!-- copyright text here -->

...
<link href="__PUBLIC__/css/RegLogin/normalize.css" rel="stylesheet"/>
<link href="__PUBLIC__/css/RegLogin/jquery-ui.css" rel="stylesheet"/>
<link href="__PUBLIC__/css/RegLogin/jquery.idealforms.min.css" rel="stylesheet" media="screen"/>

<style type="text/css">
body{font:normal 15px/1.5 Arial, Helvetica, Free Sans, sans-serif;color: #222;background:url(__PUBLIC__/img/RegLogin/pattern.png);overflow-y:scroll;padding:60px 0 0 0;}
...
<script type="text/javascript" src="__PUBLIC__/js/jquery.idealforms.js"></script>

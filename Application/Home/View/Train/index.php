...
<head>
    ...
    <link href="__PUBLIC__/css/Train/index.css" rel="stylesheet">
    ...
    <script src="__PUBLIC__/js/jquery.validation.min.js"></script>
</head>
<body>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <?php foreach($training_type as $v){?>
                            <li><a href="__APP__/home/Train/index?type_id=<?php echo $v['type_id'] ;?>"><?php echo $v['type_name'];?></a></li>
                        <?php }?>
                    </ul>
                </li>
            </ul>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="__PUBLIC__/img/Train/shouye1.jpg" alt="0 slider">
                <div class="carousel-caption">
                    <p class="carousel p">优胜教育，行业领导者</p>
                </div>
            </div>
            <div class="item">
                <img src="__PUBLIC__/img/Train/shouye1.jpg" alt="1 slider">
                <div class="carousel-caption">
                    <p></p>
                </div>
            </div>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="marleft30per">
                <form class="navbar-form" action="__APP__/Home/Train/search" method="get">
...
<div class="container">
    <div class="fabu">
        <a href="__APP__/Home/Train/fabu">
            <button type="button" class="btn btn-danger fr">发布免费信息</button>
        </a>
    </div>
    <div class="tabsbar">
        <div class="list-tabs">
            <a href="#" class="sel"><h4>天津<?php if(!empty($type_id)){

                        echo $training_type[$type_id-1]['type_name'];
    ...
    <div id="infolist">
        <table class="table table-hover">
            ...
            <tr>
                <td class="width100">
                    <img src="__PUBLIC__/img/Train/default.gif" alt="..." class="img-thumbnail" width="80" height="80">
                </td>
                <td style="line-height: 1.9;">
                    <a href="__APP__/Home/Train/detail?id=<?php echo $value['message_id'];?>"><strong><?php echo $value['message_title']?></strong></a>&nbsp;<span class="label label-warning">精</span><br />
...
<!--登录注册弹出框-->
<form class="modal fade bs-example-modal-sm" id="Loginform" method="post" action="__APP__/Home/Index/LoginSave" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<form class="modal fade bs-example-modal-sm" method="post" action="__APP__/Home/Index/Reg_save" role="form" id="registerform" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

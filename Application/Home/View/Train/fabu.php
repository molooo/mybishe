...
<head>
	...
	<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/Train/lib/sweetalert.css">
	<script src="__PUBLIC__/css/Train/lib/sweetalert.min.js"></script>
    ...
    <script src="__PUBLIC__/js/fabu.js"></script>
    ...
    <form role="form" method="post" action="__APP__/Home/Train/fabuadd" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                    ...
                    <input id="img" name="img" class="" type="hidden" value="">
